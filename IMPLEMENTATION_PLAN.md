...
|---|---|
| **Frontend** | React 19, Vite, SWC, pnpm, TailwindCSS, shadcn/ui, React Router v7, TanStack Query, Axios, React Hook Form, Zod, React Hot Toast, Phosphor Icons |
...
# 🎯 SUMMARY: PURPOSE OF THIS PLATFORM

**This platform** is an all-in-one AI-powered tool I'm building to simplify and supercharge the job search process for developers.

### 🧑‍💼 For Job Seekers
**This platform** is an all-in-one AI-powered tool I'm building to simplify and streamline the job search process for candidates.
It combines smart resume analysis, application tracking, and community inspiration in one place, solving the fragmented job search experience.

- **Perfect Their Resume**
The built-in AI analyzer scans resumes against job descriptions to ensure they pass ATS filters. It provides a detailed score, actionable suggestions, and even **customized interview questions** to help users prep.

- **Resume Sharing & Templates**
A library of open resume templates allows users to view and learn from successful resumes. Users can share their own resume to gain visibility or use shared templates to improve their design.

- **Track Applications**
A centralized dashboard helps users log every job application with its current status. Automated email reminders ensure they never miss a scheduled interview or follow-up opportunity

**In short:** This platform helps job seekers apply smarter, fix resume mistakes and stay organized during the job hunt.
